...
tracetest run test --file ./test/order-service-correct-quantity-kafka.yaml --server-url http://localhost:11633/ --skip-result-wait --output pretty
...
tracetest run test --file ./test/order-service-too-much-quantity-kafka.yaml --server-url http://localhost:11633/ --skip-result-wait --output pretty
